        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="bg-primary hover:bg-primaryDark disabled:opacity-60 text-white text-xs font-bold px-4 py-2 rounded-xl transition duration-150 shadow-sm hover:shadow-md flex items-center gap-1"
            >
