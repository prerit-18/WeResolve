...
export default function ImpactWallet({ user }) {
  ...
  return (
    <div className="relative">
      <div className="bg-gradient-to-br from-secondary via-secondaryDark to-primary rounded-2xl p-5 sm:p-6 text-white shadow-md flex flex-col sm:flex-row items-stretch justify-between gap-4">
        {/* Left Section */}
        <div className="flex flex-col justify-between flex-1">
          <div>
            <h3 className="text-sm font-semibold flex items-center gap-1.5 text-white/80 mb-3 sm:mb-4">
