...
export default function IssueCard({
  ...
  return (
    <div className="flex gap-4 p-4 border border-slate-100 rounded-2xl hover:shadow-md hover:border-slate-200 transition-all duration-200 bg-white items-center">
      {/* Issue Image */}
      <img
        src={image_url}
        alt={title}
        className="w-24 h-24 rounded-xl object-cover shrink-0 shadow-sm border border-slate-100"
      />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="bg-purple-600 hover:bg-purple-700 disabled:opacity-60 text-white text-xs font-bold px-4 py-2 rounded-xl transition duration-150 shadow-sm hover:shadow-md flex items-center gap-1"
            >
