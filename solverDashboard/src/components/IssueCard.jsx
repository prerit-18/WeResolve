        ...
        <div className="flex items-center justify-between gap-2 pt-1 border-t border-slate-50 sm:border-t-0">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="bg-purple-600 hover:bg-purple-700 disabled:opacity-60 text-white text-xs font-bold px-3.5 sm:px-4 py-2 rounded-xl transition duration-150 shadow-sm hover:shadow-md flex items-center gap-1"
            >
